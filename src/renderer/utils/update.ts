...
export const getLatestReleaseInfo = async (): Promise<GithubReleaseInfo | null> => {
  try {
    ...
    const apiUrls = [
      // 原始地址
      'https://api.github.com/repos/laksaikong/LaksaiMusicPlayer/releases/latest',

      // 使用代理节点
      'http://music.laksai.fun/package.json'
    ];
      ...
      try {
        ...
        if (url.includes('package.json')) {
          ...
          return {
            ...
            html_url: 'https://github.com/laksaikong/LaksaiMusicPlayer/releases/latest',
            assets: []
