...
const handleUpdate = async () => {
  ...
  // Android APK 下载地址
  const downloadUrl = `https://github.com/laksaikong/LaksaiMusicPlayer/releases/download/v${version}/LaksaiMusicPlayer-${version}.apk`;
  ...
  try {
    ...
    const releaseUrl =
      ...
      'https://github.com/laksaikong/LaksaiMusicPlayer/releases/latest';
