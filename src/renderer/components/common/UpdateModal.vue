      ...
      <div v-if="!downloading" class="modal-desc mt-4 text-center">
        <p class="text-xs text-gray-400">
          ...
          <a
            ...
            target="_blank"
            href="https://github.com/laksaikong/LaksaiMusicPlayer/releases"
            >GitHub</a
          >
...
const handleUpdate = async () => {
  ...
  const downUrls = {
    win32: {
      all: `https://github.com/laksaikong/LaksaiMusicPlayer/releases/download/v${version}/LaksaiMusicPlayer-${version}-win.exe`,
      x64: `https://github.com/laksaikong/LaksaiMusicPlayer/releases/download/v${version}/LaksaiMusicPlayer-${version}-win-x64.exe`,
      ia32: `https://github.com/laksaikong/LaksaiMusicPlayer/releases/download/v${version}/LaksaiMusicPlayer-${version}-win-ia32.exe`
    },
    darwin: {
      x64: `https://github.com/laksaikong/LaksaiMusicPlayer/releases/download/v${version}/LaksaiMusicPlayer-${version}-x64.dmg`,
      arm64: `https://github.com/laksaikong/LaksaiMusicPlayer/releases/download/v${version}/LaksaiMusicPlayer-${version}-arm64.dmg`
    },
    linux: {
      AppImage: `https://github.com/laksaikong/LaksaiMusicPlayer/releases/download/v${version}/LaksaiMusicPlayer-${version}-linux-x64.AppImage`,
      deb: `https://github.com/laksaikong/LaksaiMusicPlayer/releases/download/v${version}/LaksaiMusicPlayer-${version}-linux-x64.deb`
    }
  };
  ...
  if (downloadUrl) {
    ...
    window.open('https://github.com/laksaikong/LaksaiMusicPlayer/releases/latest', '_blank');
  }
};
</script>
